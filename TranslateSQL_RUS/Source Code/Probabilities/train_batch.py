...
def load_sst(text_field, label_field, batch_size):
    train, dev, test = data.TabularDataset.splits(path='C:\\Users\\sofis\\Desktop\\pytorch-sentiment-classification-master\\data\\SST2\\', train='train_q.tsv',
...
model = BiLSTMSentiment(embedding_dim=EMBEDDING_DIM, hidden_dim=HIDDEN_DIM, vocab_size=36, label_size=36,\
                          use_gpu=USE_GPU, batch_size=BATCH_SIZE)
...
#load_bin_vec('C:\\Users\\sofis\\Desktop\\pytorch-sentiment-classification-master\\data\\model.bin', word_to_idx)
for word in words:
